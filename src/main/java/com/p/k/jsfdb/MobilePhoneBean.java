...
public class MobilePhoneBean implements Serializable{
    ...
    EntityManagerFactory emf = Persistence.createEntityManagerFactory("MobilePhone");
    ...
    public List getPhones() {
        ...
        TypedQuery query = em.createQuery("select c from MobilePhone c", MobilePhone.class);
        return query.getResultList();

//        List<MobilePhone> listOfPhones = new ArrayList();
//        try {
